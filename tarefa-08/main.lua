...
local o1 = new(100, 50,200,200)
local o2 = new(50, 50,200,200)
local o3 = new(20, 50,200,200)
local o4 = new(0, 50,200,200)
...
function love.update(dt)
	...
	tempo = math.floor(segundos)
	   ...
	   if tempo>=70 then
	   		...
	   		coroutine.resume(o3.co, dt)
	   		coroutine.resume(o4.co, dt)
	   end
end
...
function love.draw()
	...
	if(tempo>=70) then
    	...
    	love.graphics.setBackgroundColor(50,205,50)
    	love.graphics.setColor(255,255,255)
    	love.audio.stop( )
    	love.graphics.print("FIM de JOGO",350,300,0,3,3)
    	local x,y = o1.get()
    	love.graphics.draw(galinhas, x,y,0,1,1)

    	local x,y = o2.get()
    	love.graphics.draw(ovoSprite, x,y, 0,0.8,0.8)
